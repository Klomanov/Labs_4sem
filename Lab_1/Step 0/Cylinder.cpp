...
int main(int argc, char** argv) {
	...
	gmsh::model::geo::addCircleArc(4, 1, 3, 1);
	gmsh::model::geo::addCircleArc(3, 1, 2, 2);
	gmsh::model::geo::addCircleArc(2, 1, 5, 3);
	gmsh::model::geo::addCircleArc(5, 1, 4, 4);

	gmsh::model::geo::addCircleArc(9, 6, 8, 5);
	gmsh::model::geo::addCircleArc(8, 6, 7, 6);
	gmsh::model::geo::addCircleArc(7, 6, 10, 7);
	gmsh::model::geo::addCircleArc(10, 6, 9, 8);
	...
	gmsh::model::geo::addCurveLoop({ 1, 10, -5, -11 }, 4);
	gmsh::model::geo::addCurveLoop({ 4, 11, -8, -12 }, 5);
	gmsh::model::geo::addCurveLoop({ 3, 12, -7, -9 }, 6);
